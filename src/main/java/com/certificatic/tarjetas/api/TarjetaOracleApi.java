...
import com.certificatic.tarjetas.service.TarjetaServiceOracle;
...
public class TarjetaOracleApi {
	
	
	@Autowired
	private TarjetaServiceOracle tarjetaService;
	...
	public TarjetaEntity obtenerTarjeta(@PathVariable(name="numeroTarjeta") String numeroTarjeta) {
